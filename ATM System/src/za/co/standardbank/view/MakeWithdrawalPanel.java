...
import za.co.standardbank.control.WithdrawalController;
...
public class MakeWithdrawalPanel extends JPanel {
	...
	public MakeWithdrawalPanel()
	{
		...
		loginButtonPanel.add(withdrawButton);
		//----------------------------------------------------------------------end---
	...
	private class withdrawButtonAction implements ActionListener
	{
		...
		{
			errorLabel.setText(WithdrawalController.
					makeWithdrawal(amountTextField.getText(), (String)accountComboBox.getSelectedItem()));
