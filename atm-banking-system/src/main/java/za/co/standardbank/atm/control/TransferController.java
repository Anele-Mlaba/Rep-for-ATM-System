...
public class TransferController {
	public static String makeTransfer(String accountFromName, String accountToName, String amount)
	{
		...
		{
			String errorMessageForAccountTo = UserInputValidations.validateAccountInput(accountToName);
			String errorMessageForAccountFrom = UserInputValidations.validateAccountInput(accountFromName);
			
			if(errorMessageForAccountTo.equals("") && errorMessageForAccountFrom.equals(""))
			{
			...
			{
				 if(errorMessageForAccountTo.equals(""))
				 {
					 return errorMessageForAccountFrom;
				 }
				 else
				 {
					 return errorMessageForAccountTo;
				 }
			}
		}
		else
